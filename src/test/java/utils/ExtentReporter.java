...
public class ExtentReporter implements ITestListener{
	...
	public void onFinish(ITestContext context)
	{
		...
		suiteNode.info("Suite Passed: " + context.getPassedTests().size());
		suiteNode.info("Suite Failed: " + context.getFailedTests().size());
		suiteNode.info("Suite Skipped: " + context.getSkippedTests().size());
